...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2019 at 02:07 PM
...
--
-- Dumping data for table `people_date`
--

INSERT INTO `people_date` (`people_id`, `people_infotype_id`, `people_date`) VALUES
(1, 4, '2010-02-02');
...
(13, 'spouse_name', 4),
(14, 'quota', 1),
(15, 'present_care_of', 4),
(16, 'present_address', 5),
(17, 'present_district', 1),
(18, 'present_upazila', 1),
(19, 'present_p_o', 4),
(20, 'present_p_c', 1),
(21, 'permanent_care_of', 4),
(22, 'permanent_address', 5),
(23, 'permanent_district', 1),
(24, 'permanent_upazila', 1),
(25, 'permanent_p_o', 4),
(26, 'permanent_p_c', 1),
(27, 'mobile_number', 4),
(29, 'email_address', 4),
...
--
-- Dumping data for table `people_integer`
--

INSERT INTO `people_integer` (`people_id`, `people_infotype_id`, `people_integer`) VALUES
(1, 42, 1),
(1, 6, 1),
(1, 7, 1),
(1, 11, 1),
...
--
-- Dumping data for table `people_text`
--

INSERT INTO `people_text` (`people_id`, `people_infotype_id`, `people_text`) VALUES
(1, 5, 'Bhangura Bazer, Bhangua, Pabna.'),
(1, 16, 'DFGDFGDF'),
(1, 22, 'GDSFGSDFGS');
...
(1, 2, 'MOHAMMAD MUSTAK AHEMMD'),
(1, 3, 'HAMIDA BEGUM'),
(1, 8, '8252583052'),
(1, 9, '19971234567895'),
(1, 10, 'BGD125128'),
(1, 15, 'MOHAMMAD MUSTAK AHMED'),
(1, 19, 'DFGDFGFD'),
(1, 21, 'MOHAMMAD MUSTAK AHMED'),
(1, 25, 'FDGDFGDF'),
(1, 27, '017-1053-4092'),
(1, 29, 'hafijul233@gmail.com');
